...
public class DerisaviSplayTree<Value> extends AbstractBisimulation<Value>{

	

	public DerisaviSplayTree(PrismComponent parent) throws PrismException {
	...
	protected DTMC<Value> minimiseDTMC(DTMC<Value> dtmc, List<String> propNames, List<BitSet> propBSs){
		...
		mainLog.println("Minimisation with DerisaviSplayTree: " + numStates + " to " + numBlocks + " States ");
