...
module process1
	...
	// pick value
	[pick] (s1=0) -> 0.0625 : (s1'=1) & (p1'=0) & (v1'=0) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=1) & (v1'=1) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=2) & (v1'=2) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=3) & (v1'=3) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=4) & (v1'=4) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=5) & (v1'=5) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=6) & (v1'=6) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=7) & (v1'=7) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=8) & (v1'=8) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=9) & (v1'=9) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=10) & (v1'=10) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=11) & (v1'=11) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=12) & (v1'=12) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=13) & (v1'=13) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=14) & (v1'=14) & (u1'=true)
		       + 0.0625 : (s1'=1) & (p1'=15) & (v1'=15) & (u1'=true);
	// read
