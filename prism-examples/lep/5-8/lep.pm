...
module process1
	...
	// pick value
	[pick] (s1=0) -> 0.125 : (s1'=1) & (p1'=0) & (v1'=0) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=1) & (v1'=1) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=2) & (v1'=2) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=3) & (v1'=3) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=4) & (v1'=4) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=5) & (v1'=5) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=6) & (v1'=6) & (u1'=true)
		       + 0.125 : (s1'=1) & (p1'=7) & (v1'=7) & (u1'=true);
	// read
	[read] (s1=1) & (u1) & !(p1=v2) & (c<N) -> (u1'=true) & (v1'=v2);
	[read] (s1=1) & (u1) &  (p1=v2) & (c<N) -> (u1'=false) & (v1'=v2);
	[read] (s1=1) & (!u1) & (c<N) -> (u1'=false) & (v1'=v2);
	// read and move to decide
	[read] (s1=1) & (u1) & !(p1=v2) & (c=N) -> (s1'=2) & (u1'=true) & (v1'=0);
	[read] (s1=1) & (u1) &  (p1=v2) & (c=N) -> (s1'=2) & (u1'=false) & (v1'=0);
